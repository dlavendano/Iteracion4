...
public class DAOPreferenciasZona {
	Date fecha = new Date();
	/**
...
//	}
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addPreferencia(VerificarPreferenciaZona preferencia) throws SQLException, Exception {

		String sql = "INSERT INTO PREFERENCIA_ZONA (ID_USUARIO ,ID_ZONA ) VALUES (";
		sql += preferencia.getUsuario().getId() + ",";
		sql += preferencia.getZona().getId() + ")";
